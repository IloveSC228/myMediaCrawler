...
class WeiboLogin(AbstractLogin):
    ...
    async def popup_login_dialog(self):
        ...
        try:
            ...
            self.logger.error(f"[WeiboLogin.popup_login_dialog] login dialog box does not pop up automatically, error: {e}")
            self.logger.error("[WeiboLogin.popup_login_dialog] login dialog box does not pop up automatically, we will manually click the login button")
            # utils.logger.error(
            ...
            try:
                ...
                self.logger.error(f"[WeiboLogin.popup_login_dialog] manually click the login button faield maybe login dialog Appear：{e}")
    ...
    async def login_by_qrcode(self):
        ...
        if not base64_qrcode_img:
            self.logger.warning("微博爬虫未能找到登录二维码")
    ...
    async def login_by_cookies(self):
        ...
        self.logger.info("微博爬虫cookie登录成功")
