...
# mysql config
RELATION_DB_PWD = os.getenv("RELATION_DB_PWD", "cqu1701")
RELATION_DB_USER = os.getenv("RELATION_DB_USER", "root")
RELATION_DB_HOST = os.getenv("RELATION_DB_HOST", "10.242.187.124")
RELATION_DB_PORT = os.getenv("RELATION_DB_PORT", "3306")
RELATION_DB_NAME = os.getenv("RELATION_DB_NAME", "social_monitor")
