...
class WeiboCsvStoreImplement(AbstractStore):
    ...
    def make_save_file_name(self, store_type: str) -> str:
        ...
        return f"{self.csv_store_path}/wb_{self.file_count}_{crawler_type_var.get()}_{store_type}_{utils.get_current_date()}.csv"
...
class WeiboDbStoreImplement(AbstractStore):
    async def store_hotlist(self, hotlist_item: Dict):
        ...
        from .weibo_store_sql import (add_new_hotlist,
    ...
    async def store_extract_info(self, extract_info_item: Dict):
        ...
        """
        from .weibo_store_sql import (add_new_extract_info,
                                         query_extract_info,
                                         update_extract_info)
